...
@Module({
  imports: [],
  controllers: [AppController, user_controller, rol_controller, ActionController, permission_controller, CompanyController, EstablishmentController, users_roles_controller],
  providers: [AppService, user_service, prisma_service,rol_service,users_roles_service,permission_service],
})
